      ...
      <provider name="Microsoft-WindowsPhone-LocationServiceProvider"
        ...
        <maps>
          ...
          <valueMap name="DriverCommandType">
            ...
            <map value="17" message="$(string.Map.SetSuplVersion2)"/>
          </valueMap>
        ...
        <templates>
          ...
          <template tid="tSuplVersion2">
            <data name="Major" inType="win:UInt32" />
            <data name="Minor" inType="win:UInt32" />
            <data name="ServInd" inType="win:UInt32" />
          </template>
        ...
        <events>
          ...
          <event
            ...
            level="win:Informational"
            opcode="win:Info"
            template="tSuplVersion2"
            message="$(string.Event.SuplVersion2)" />
  ...
  <localization>
    <resources culture="en-US">
      ...
      <stringTable>
        ...
        <string id="Map.SetSuplVersion2"              value="SetSuplVersion2" />
        ...
        <string id="Event.SuplVersion2"                   value="Set SUPL version: %1.%2.%3"/>
