...
--*/
{
  ...
  if (GigAdapter->hw.mac.type == e1000_pch_spt ||
      ...
      GigAdapter->hw.mac.type == e1000_pch_tgp ||
      GigAdapter->hw.mac.type == e1000_pch_adp ||
      GigAdapter->hw.mac.type == e1000_pch_mtp )
  {
...
--*/
{
  ...
  if(e1000_pch_spt == GigAdapter->hw.mac.type ||
     ...
     e1000_pch_tgp == GigAdapter->hw.mac.type ||
     e1000_pch_adp == GigAdapter->hw.mac.type ||
     e1000_pch_mtp == GigAdapter->hw.mac.type) {
    // Fextnvm7 @ 0xe4[2] = 1
