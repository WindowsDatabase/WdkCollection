        ...
        if (statusRegister[0] != nullptr)
        {
            ...
            if (hr == S_OK)
            {
                ...
                *pValue = 0;
                ...
                size_t copySize = min(buffer.GetLength(), sizeof(*pValue));
...
HRESULT GdbSrvController::WriteMsrRegister(_In_ DWORD dwProcessorNumber, _In_ DWORD dwRegisterIndex, _Out_ ULONG64 value)
{
    assert(m_pGdbSrvControllerImpl != nullptr);    
