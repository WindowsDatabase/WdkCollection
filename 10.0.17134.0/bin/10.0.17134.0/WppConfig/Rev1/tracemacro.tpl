...
# define WPP_LOGCSTR(_x) \
    WPP_LOGPAIR( sizeof((_x).Length), &(_x).Length ) WPP_LOGPAIR( (_x).Length, (_x).Length?(_x).Buffer:"" )
#endif

#if !defined(WPP_LOGUSTR)
# define WPP_LOGUSTR(_x) \
    WPP_LOGPAIR( sizeof((_x).Length), &(_x).Length ) WPP_LOGPAIR( (_x).Length, (_x).Length?(_x).Buffer:L"" )
#endif
...
# define WPP_LOGPUSTR(_x) WPP_LOGPAIR( sizeof(USHORT), (_x)?&(_x)->Length:L"\x08" ) \
                          WPP_LOGPAIR( (_x)?(_x)->Length:0x08, (_x)&&(_x)->Length?(_x)->Buffer:L"NULL" )
#endif
#endif
...
# define WPP_LOGPCSTR(_x) WPP_LOGPAIR( sizeof(USHORT), (_x)?&(_x)->Length:L"\x04" ) \
                          WPP_LOGPAIR( (_x)?(_x)->Length:0x04, (_x)&&(_x)->Length?(_x)->Buffer:"NULL" )
#endif
#endif
...
#define WPP_CALL_`i.Name`(`i.FixedArgs``i.MacroArgs`) \
    ...
    (( \
        ...
        WPP_SF_`i.TypeSig`(WPP`i.GooId`_LOGGER(`i.GooVals`) \
                           `i.MsgNo`, \
