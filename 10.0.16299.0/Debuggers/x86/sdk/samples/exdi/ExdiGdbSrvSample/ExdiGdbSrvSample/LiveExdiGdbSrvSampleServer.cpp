        ...
        /* [out] */ SAFEARRAY * *pReadBuffer)
{
    ...
    try
    {
        ...
        memoryReadType memoryType = {0};
        memoryType.isReadPhysical = 1;
        ...
        /* [out] */ DWORD *pdwBytesWritten)
{
    ...
    try
    {
        ...
        bool isWriteDone = pController->WriteMemory(Address, bufferSize, pRawBuffer, pdwBytesWritten, true);
        if (isWriteDone)
        {
    	    return S_OK;
        }
