...

{
    if (KdSerialBaudDividend != 0) {
        ...
        HardwareWriteUchar(pPort->Address, 0, (UCHAR)(DivisorLatch & 0xff));
...
//
// The new 16550 implementation doesn't ever need a transformation
//

KD_HARDWARE_LAYER_DRIVER MM16550HardwareLayerDriver = {
