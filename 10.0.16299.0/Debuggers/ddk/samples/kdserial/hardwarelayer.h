...
extern KD_HARDWARE_LAYER_DRIVER MM16550HardwareLayerDriver;
...
extern KD_HARDWARE_LAYER_DRIVER SDM845HardwareLayerDriver;
...
//
// This macro is used to decide if the KD_HARDWARE_LAYER_DRIVER respects all the
// fields in the ACPI Generic Address Structure (GAS) including AccessSize and
// BitWidth.
//
// Currently only the memory mapped 16550 (subtype 0x12) does this.
//

#define KD_HARDWARE_LAYER_RESPECTS_GAS(type) ((type) == 0x12)
