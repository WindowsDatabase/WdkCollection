...
typedef enum _DEBUG_FLR_PARAM_TYPE {
    ...
    DEBUG_FLR_SVCHOST_GROUP,          // "%SystemRoot%\System32\svchost.exe -k LocalService" --> "LocalService"
    ...
    // Analysis Key/Values
    DEBUG_FLR_KEY_VALUES_STRING = 0x110000,
    DEBUG_FLR_KEY_VALUES_VARIANT = 0x120000,
