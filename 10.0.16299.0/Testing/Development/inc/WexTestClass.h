...
#if _MSC_VER < 1800
# error Unsupported version of Visual Studio. WexTestClass.h requires VS 2013 or later.
#endif
...
namespace WEX
{
    ...
    {
#if defined(__clang__)
        // Helper function to index into arrays to build up big std::array with concatenated characters of two c strings. 
...
# define TAEF_QUALIFIED_METHOD_NAME &TAEF_szQualifiedMethodName[0]
...
# define TAEF_REGISTER_FIXTURE_METHOD(methodName, methodType) \
    ...
    static const ::WEX::FixtureMethodInfo s_testInfo = {methodType, L#methodName, TAEF_QUALIFIED_METHOD_NAME, &TAEF_FixtureInvoker::TAEF_Invoke}; \
...
# define TAEF_REGISTER_TEST_METHOD(methodName) \
    ...
    static const ::WEX::TestMethodInfo s_testInfo = {::WEX::TAEF_Identifier::TestMethodInfo, L#methodName, TAEF_QUALIFIED_METHOD_NAME,  \
