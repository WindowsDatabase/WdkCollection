...
set SIGN_NULL=1
for %%i in (%SIGNTOOL_OEM_SIGN_PKG%) do if not "%%i"=="" set SIGN_NULL=0

if "%SIGN_NULL%"=="1" (
    set SIGNTOOL_OEM_SIGN_PKG=/a /s my /i "Windows OEM Intermediate 2017 (TEST ONLY)" /n "Windows OEM Test Cert 2017 (TEST ONLY)" /fd SHA256
)
...
if "%CERTIFICATEFLAG%"=="app" set CERTIFICATE=/s my /i "Windows OEM Intermediate 2017 (TEST ONLY)" /n "Windows OEM App Test Cert 2017 (TEST ONLY)" /fd SHA256
REM
...
if "%CERTIFICATEFLAG%"=="pp" set CERTIFICATE=/s my /i "Windows OEM Intermediate 2017 (TEST ONLY)" /n "Windows OEM PP Test Cert 2017 (TEST ONLY)" /fd SHA256
if "%CERTIFICATEFLAG%"=="ppl" set CERTIFICATE=/s my /i "Windows OEM Intermediate 2017 (TEST ONLY)" /n "Windows OEM PPL Test Cert 2017 (TEST ONLY)" /fd SHA256
if "%CERTIFICATEFLAG%"=="pk" set CERTIFICATE=/s my /i "Windows OEM Intermediate FFU Cert 2017 (TEST ONLY)" /n "Windows OEM Test Platform Key Cert 2017 (TEST ONLY)" /fd SHA256
...
if "%CERTIFICATEFLAG%"=="pkg" set CERTIFICATE=%SIGNTOOL_OEM_SIGN_PKG%
goto :SIGNLOOP
