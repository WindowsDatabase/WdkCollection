...
#ifndef _NETPACKETQUEUE_H_
#define _NETPACKETQUEUE_H_
...
} NET_PACKET_QUEUE_CONFIG, *PNET_PACKET_QUEUE_CONFIG;

FORCEINLINE
VOID
NET_PACKET_QUEUE_CONFIG_INIT(
    _Out_ PNET_PACKET_QUEUE_CONFIG Config,
