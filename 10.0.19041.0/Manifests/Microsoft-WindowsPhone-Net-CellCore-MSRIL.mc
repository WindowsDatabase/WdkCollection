      ...
      <provider name="Microsoft-WindowsPhone-Net-CellCore-MSRil"
        ...
        <maps>
            ...
            <valueMap name="RilNotificationID">
                ...
                <map value="0x10000136" message="$(string.RilNotificationID.RIL_NOTIFY_CONFPARTICIPANTSTATUS)" />
                <map value="0x10000137" message="$(string.RilNotificationID.RIL_NOTIFY_SMSREADYSTATUS)" />
                <map value="0x10000138" message="$(string.RilNotificationID.RIL_NOTIFY_REQUESTGEOLOCATIONDATA)" />
            </valueMap>
        </maps>
  ...
  <localization>
    <resources culture="en-US">
      <stringTable>
        ...
        <string id="RilNotificationID.RIL_NOTIFY_CONFPARTICIPANTSTATUS" value="RIL_NOTIFY_CONFPARTICIPANTSTATUS" />
        <string id="RilNotificationID.RIL_NOTIFY_SMSREADYSTATUS" value="RIL_NOTIFY_SMSREADYSTATUS" />
        <string id="RilNotificationID.RIL_NOTIFY_REQUESTGEOLOCATIONDATA" value="RIL_NOTIFY_REQUESTGEOLOCATIONDATA" />
