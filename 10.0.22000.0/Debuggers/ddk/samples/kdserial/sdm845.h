...
/*---------------------------------------------------------------------------------------
Function: SDM845GetByte
input   : PCPPORT
output  : Character read from UART port
---------------------------------------------------------------------------------------*/
UART_STATUS
SDM845GetByte (
    _Inout_ PCPPORT Port,
...
/*---------------------------------------------------------------------------------------
Function: SDM845PutByte
input   : PCPPORT
input   : Character send to UART port
---------------------------------------------------------------------------------------*/
UART_STATUS
SDM845PutByte (
    _Inout_ PCPPORT Port,
