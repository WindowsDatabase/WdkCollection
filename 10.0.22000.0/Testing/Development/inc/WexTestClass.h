...
# if (TAEF_ABI_VERSION != 10) && (TAEF_ABI_VERSION != 11)
#  error TAEF_ABI_VERSION is set to an unsupported value. This version of WexTestClass.h only supports ABI versions 10 and 11.
# endif
# if (TAEF_ABI_VERSION == 10) && (defined(__clang__) || !defined(_WIN32))
#  error TAEF ABI version 10 is no longer supported unless building with MSVC on Windows. Please switch to ABI version 11 or leave TAEF_ABI_VERSION undefined.
# endif
#else
// TAEF_ABI_VERSION is not defined. Set it to a default value.
# if defined(__clang__) || !defined(_WIN32)
#  define TAEF_ABI_VERSION 11
# else
// For now, we still default to version 10 for MSVC, but the plan is to change the default to 11 soon.
...
# endif // #if defined(_WIN32)
    ...
    struct MetadataIdentifierLookup<const char&, const ValueCharType&>
    {
        static_assert(WEX::Common::AreSameType<ValueCharType, char>::value,
            "Invalid mix of narrow and wide string in TAEF metadata. A narrow string was used for the name and a wide string was used for the value.");

        static const ::WEX::Private::TaefAbiStructIdentifier c_moduleIdentifier = ::WEX::Private::TaefAbiStructIdentifier::ModuleMetadataNarrow;
        static const ::WEX::Private::TaefAbiStructIdentifier c_classIdentifier = ::WEX::Private::TaefAbiStructIdentifier::TestClassMetadataNarrow;
        static const ::WEX::Private::TaefAbiStructIdentifier c_methodIdentifier = ::WEX::Private::TaefAbiStructIdentifier::TestMethodMetadataNarrow;
    };

    template <typename ValueCharType>
    struct MetadataIdentifierLookup<const wchar_t&, const ValueCharType&>
    {
        static_assert(WEX::Common::AreSameType<ValueCharType, wchar_t>::value,
            "Invalid mix of narrow and wide string in TAEF metadata. A wide string was used for the name and a narrow string was used for the value.");

        static const ::WEX::Private::TaefAbiStructIdentifier c_moduleIdentifier = ::WEX::Private::TaefAbiStructIdentifier::ModuleMetadata;
        static const ::WEX::Private::TaefAbiStructIdentifier c_classIdentifier = ::WEX::Private::TaefAbiStructIdentifier::TestClassMetadata;
        static const ::WEX::Private::TaefAbiStructIdentifier c_methodIdentifier = ::WEX::Private::TaefAbiStructIdentifier::TestMethodMetadata;
    };
...
namespace WEX { namespace Private
{
    ...
    extern "C" TAEF_TESTDATA_SECTION($a_TDH) __declspec(selectany) TestVersionInfo s_versionInfo =
        {TAEF_HEADER_SIGNATURE, TAEF_ABI_VERSION, "WexTestClass.h", StringManager::Deallocate};
