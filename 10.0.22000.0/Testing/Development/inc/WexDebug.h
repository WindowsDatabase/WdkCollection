...
namespace WEX { namespace Common
{
    ...
    public:
        ...
        static void WEXCOMMON_STDCALL Assert(bool condition, const __wchar_t* pszCondition, const __wchar_t* pszMessage, 
            const __wchar_t* pszFile, const __wchar_t* pszFunction, int line);

#if defined(_WIN32)
        static void WEXCOMMON_STDCALL Write(const __wchar_t* pszString)
        {
#ifndef NDEBUG
        ...
        static void WEXCOMMON_STDCALL WriteLine(const __wchar_t* pszString)
        {
#ifndef NDEBUG
    ...
    private:
        ...
        // wchar_t native type exports
#ifdef WEXCOMMON_FULL_BUILD
        static void WEXCOMMON_STDCALL WriteImpl(const __wchar_t* pszString);
        static void WEXCOMMON_STDCALL WriteLineImpl(const __wchar_t* pszString);
#endif
