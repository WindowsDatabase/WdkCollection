...
//----------------------------------------------------------------------------------------------------------------------
#ifndef __WEXSTRING_H__
#define __WEXSTRING_H__
...
#pragma push_macro("_Ret_writes_maybenull_")
...
namespace WEX { namespace Common
{
    ...
    public:
        ...
        /// <summary>Trims all leading and trailing occurrences of character 'ch'</summary>
        ...
        static bool WEXCOMMON_STDCALL IsNullOrEmpty(_In_opt_z_ const wchar_t* psz)
        {
            return !psz || *psz == L'\0';
        }
        ...
        static bool WEXCOMMON_STDCALL IsNullOrEmpty(const __wchar_t* psz)
        {
    ...
    private:
        friend WEXCOMMON_API int WEXCOMMON_STDCALL GetBufferLength(const String& string);
        friend WEXCOMMON_API void WEXCOMMON_STDCALL swap(String& str1, String& str2);
    ...
    WEXCOMMON_API int WEXCOMMON_STDCALL GetBufferLength(const String& string);
    
    WEXCOMMON_API bool WEXCOMMON_STDCALL operator==(const String& str1, const String& str2);

    WEXCOMMON_API bool WEXCOMMON_STDCALL operator==(const String& str, _In_z_ const wchar_t* psz);
    
    WEXCOMMON_API bool WEXCOMMON_STDCALL operator==(_In_z_ const wchar_t* psz, const String& str);
    ...
    WEXCOMMON_API String WEXCOMMON_STDCALL operator+(String str1, const String& str2);

    /// <summary></summary>
    /// <param name="str"> </param>
    /// <param name="ch"> </param>
    WEXCOMMON_API String WEXCOMMON_STDCALL operator+(String str, wchar_t ch);

    /// <summary></summary>
    /// <param name="ch"> </param>
    /// <param name="str"> </param>
    WEXCOMMON_API String WEXCOMMON_STDCALL operator+(wchar_t ch, const String& str);

    /// <summary></summary>
    /// <param name="str"> </param>
    /// <param name="ch"> </param>
    WEXCOMMON_API String WEXCOMMON_STDCALL operator+(String str, char ch);

    /// <summary></summary>
    /// <param name="ch"> </param>
    /// <param name="str"> </param>
    WEXCOMMON_API String WEXCOMMON_STDCALL operator+(char ch, const String& str);

    /// <summary></summary>
    /// <param name="str"> </param>
    /// <param name="lpsz"> </param>
    WEXCOMMON_API String WEXCOMMON_STDCALL operator+(String str, _In_z_ const wchar_t* lpsz);

    /// <summary></summary>
    /// <param name="psz"> </param>
    /// <param name="str"> </param>
    WEXCOMMON_API String WEXCOMMON_STDCALL operator+(_In_z_ const wchar_t* psz, const String& str);

    // wchar_t native type exports
    #ifdef WEXCOMMON_FULL_BUILD
    WEXCOMMON_API bool WEXCOMMON_STDCALL operator==(const String& str, _In_z_ const __wchar_t* psz);
    WEXCOMMON_API bool WEXCOMMON_STDCALL operator==(_In_z_ const __wchar_t* psz, const String& str);
    WEXCOMMON_API bool WEXCOMMON_STDCALL operator!=(const String& str, _In_z_ const __wchar_t* psz);
    WEXCOMMON_API bool WEXCOMMON_STDCALL operator!=(_In_z_ const __wchar_t* psz, const String& str);
    WEXCOMMON_API bool WEXCOMMON_STDCALL operator<(const String& str, _In_z_ const __wchar_t* psz);
    WEXCOMMON_API bool WEXCOMMON_STDCALL operator<(_In_z_ const __wchar_t* psz, const String& str);
    ...
    WEXCOMMON_API bool WEXCOMMON_STDCALL operator>=(const String& str, _In_z_ const __wchar_t* psz);
    WEXCOMMON_API bool WEXCOMMON_STDCALL operator>=(_In_z_ const __wchar_t* psz, const String& str);
    WEXCOMMON_API String WEXCOMMON_STDCALL operator+(String str, __wchar_t ch);
    WEXCOMMON_API String WEXCOMMON_STDCALL operator+(__wchar_t ch, const String& str);
    WEXCOMMON_API String WEXCOMMON_STDCALL operator+(String str, _In_z_ const __wchar_t* lpsz);
    WEXCOMMON_API String WEXCOMMON_STDCALL operator+(_In_z_ const __wchar_t* psz, const String& str);
    #endif

    WEXCOMMON_API void WEXCOMMON_STDCALL swap(String& str1, String& str2);
    ...
    public:
        ...
        _Ret_writes_maybenull_(length + 1) unsigned short* GetBufferSetLength(int length);
        ...
        static bool WEXCOMMON_STDCALL IsNullOrEmpty(const wchar_t* psz)
        {
    ...
    private:
        ...
        friend WEXCOMMON_API int WEXCOMMON_STDCALL GetBufferLength(const NoThrowString& string);
        friend WEXCOMMON_API void WEXCOMMON_STDCALL swap(NoThrowString& str1, NoThrowString& str2);
    ...
    WEXCOMMON_API int WEXCOMMON_STDCALL GetBufferLength(const NoThrowString& string);

    WEXCOMMON_API bool WEXCOMMON_STDCALL operator==(const NoThrowString& str1, const NoThrowString& str2);

    WEXCOMMON_API bool WEXCOMMON_STDCALL operator==(const NoThrowString& str, _In_z_ const wchar_t* psz);
    
    WEXCOMMON_API bool WEXCOMMON_STDCALL operator==(_In_z_ const wchar_t* psz, const NoThrowString& str);
    ...
    /// <param name="str1"> </param>
    /// <param name="str2"> </param>
    WEXCOMMON_API NoThrowString WEXCOMMON_STDCALL operator+(NoThrowString str1, const NoThrowString& str2);

    /// <summary> </summary>
    /// <param name="ch"> </param>
    WEXCOMMON_API NoThrowString WEXCOMMON_STDCALL operator+(NoThrowString str, wchar_t ch);

    /// <summary> </summary>
    /// <param name="ch"> </param>
    /// <param name="str"> </param>
    WEXCOMMON_API NoThrowString WEXCOMMON_STDCALL operator+(wchar_t ch, const NoThrowString& str);

    /// <summary> </summary>
    /// <param name="str"> </param>
    /// <param name="ch"> </param>
    WEXCOMMON_API NoThrowString WEXCOMMON_STDCALL operator+(NoThrowString str, char ch);

    /// <summary> </summary>
    /// <param name="ch"> </param>
    /// <param name="str"> </param>
    WEXCOMMON_API NoThrowString WEXCOMMON_STDCALL operator+(char ch, const NoThrowString& str);

    /// <summary> </summary>
    /// <param name="str"> </param>
    /// <param name="lpsz"> </param>
    WEXCOMMON_API NoThrowString WEXCOMMON_STDCALL operator+(NoThrowString str, _In_z_ const wchar_t* lpsz);

    /// <summary> </summary>
    /// <param name="psz"> </param>
    /// <param name="str"> </param>
    WEXCOMMON_API NoThrowString WEXCOMMON_STDCALL operator+(_In_z_ const wchar_t* psz, const NoThrowString& str);

    // wchar_t native type exports
    #ifdef WEXCOMMON_FULL_BUILD
    WEXCOMMON_API bool WEXCOMMON_STDCALL operator==(const NoThrowString& str, _In_z_ const __wchar_t* psz);
    WEXCOMMON_API bool WEXCOMMON_STDCALL operator==(_In_z_ const __wchar_t* psz, const NoThrowString& str);
    WEXCOMMON_API bool WEXCOMMON_STDCALL operator!=(const NoThrowString& str, _In_z_ const __wchar_t* psz);
    WEXCOMMON_API bool WEXCOMMON_STDCALL operator!=(_In_z_ const __wchar_t* psz, const NoThrowString& str);
    WEXCOMMON_API bool WEXCOMMON_STDCALL operator<(const NoThrowString& str, _In_z_ const __wchar_t* psz);
    WEXCOMMON_API bool WEXCOMMON_STDCALL operator<(_In_z_ const __wchar_t* psz, const NoThrowString& str);
    ...
    WEXCOMMON_API bool WEXCOMMON_STDCALL operator>=(const NoThrowString& str, _In_z_ const __wchar_t* psz);
    WEXCOMMON_API bool WEXCOMMON_STDCALL operator>=(_In_z_ const __wchar_t* psz, const NoThrowString& str);
    WEXCOMMON_API NoThrowString WEXCOMMON_STDCALL operator+(NoThrowString str, __wchar_t ch);
    WEXCOMMON_API NoThrowString WEXCOMMON_STDCALL operator+(__wchar_t ch, const NoThrowString& str);
    WEXCOMMON_API NoThrowString WEXCOMMON_STDCALL operator+(NoThrowString str, _In_z_ const __wchar_t* lpsz);
    WEXCOMMON_API NoThrowString WEXCOMMON_STDCALL operator+(_In_z_ const __wchar_t* psz, const NoThrowString& str);
    #endif

    WEXCOMMON_API void WEXCOMMON_STDCALL swap(NoThrowString& str1, NoThrowString& str2);
...
#pragma pop_macro("_Ret_writes_maybenull_")
#endif // #if !defined(_WIN32)

#endif //__WEXSTRING_H__
