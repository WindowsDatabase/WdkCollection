...
IF NOT "%SDXROOT%"=="" (
        SET BE=razzle
        ECHO Warning: SMV requires OACR disabled.  Start razzle with no_oacr switch.
        ECHO Warning: SMV requires sdxwrite, multiwritestrict, readwrite, and includes disabled.
        ECHO Warning: In %OSBuildBranchConfig%\Core\dbb_report_config.xml set Enabled to false.
)
...
:LIB
"%smv%\bin\smv" /plugin:"%sdvap%\bin\smvsdv.dll" /config:"%sdvap%\configurations\%BE%-build.xml" %1 %2 %3 %4 %5 %6 %7 %8
GOTO EXIT
