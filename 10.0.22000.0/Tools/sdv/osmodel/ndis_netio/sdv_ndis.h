...
#ifdef NdisFreeMemoryWithTag
#undef NdisFreeMemoryWithTag
#endif    
#define NdisFreeMemoryWithTag sdv_NdisFreeMemoryWithTag  
VOID
sdv_NdisFreeMemoryWithTag(
    IN PVOID  VirtualAddress,
    IN ULONG Tag
    );

#ifdef NdisFreeMemoryWithTagPriority
#undef NdisFreeMemoryWithTagPriority
#endif    
#define NdisFreeMemoryWithTagPriority sdv_NdisFreeMemoryWithTagPriority
VOID
sdv_NdisFreeMemoryWithTagPriority(
	IN NDIS_HANDLE NdisHandle,
    IN PVOID  VirtualAddress,
    IN ULONG Tag
    );
