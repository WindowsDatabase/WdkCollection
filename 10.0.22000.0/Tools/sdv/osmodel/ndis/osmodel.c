...
{
  SdvAssume(*(UCHAR*)VirtualAddress == *(UCHAR*)VirtualAddress);
  sdv_ExFreePool( VirtualAddress );	
}
...
{
  SdvAssume(*(UCHAR*)VirtualAddress == *(UCHAR*)VirtualAddress);
  sdv_ExFreePoolWithTag( VirtualAddress, Tag );
