...
namespace WEX { namespace TestExecution
{
    ...
    namespace Interruption
    {
        ...
        namespace Private
        {
            ...
            extern "C" TECOMMON_API void TAEF_STDCALL Interruption_Disconnect(DisconnectOption);
        }/* namespace Private */
        
        inline void Disconnect() { Private::Interruption_Disconnect(Private::DisconnectOption::Default); }
#endif

        TECOMMON_API void TAEF_STDCALL Reboot(RebootOption::Option option);
        TECOMMON_API void TAEF_STDCALL RebootCustom(RebootOption::Option option);
    }/* namespace Interruption */
