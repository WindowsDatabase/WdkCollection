  ...
  if (!EFI_ERROR (Status)) {
    ...
    if (Pci.Hdr.VendorId == INTEL_VENDOR_ID) {
      if (
        ...
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_CML_I219_LM10 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_CML_I219_V10 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_CML_I219_LM11 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_CML_I219_V11 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_CML_I219_LM12 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_CML_I219_V12 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_TGL_I219_LM13 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_TGL_I219_V13 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_TGL_I219_LM14 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_TGL_I219_V14 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_EBG_I219_LM15 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_EBG_I219_V15 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_ADL_I219_LM16 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_ADL_I219_V16 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_ADL_I219_LM17 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_ADL_I219_V17 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_MTL_I219_LM18 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_MTL_I219_V18 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_MTL_I219_LM19 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_MTL_I219_V19 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_LNL_I219_LM20 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_LNL_I219_V20 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_LNL_I219_LM21 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_LNL_I219_V21 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_RPL_I219_LM22 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_RPL_I219_V22 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_RPL_I219_LM23 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_RPL_I219_V23 ||
